...
#LABEL_LIST = ['CRIME', 'TRANSPORT_HAZARDS', 'SUICIDE_ATTACK', 'VEHICULAR_COLLISION', 'INDUSTRIAL_ACCIDENT', 'FIRE', 'AVIATION_HAZARD', 'SHOOT_OUT', 'RIOTS', 'ACCIDENTS', 'TRAIN_COLLISION', 'SURGICAL_STRIKES', 'MISCELLANEOUS', 'NORMAL_BOMBING', 'ARMED_CONFLICTS','TERRORIST_ATTACK','O' ,"X", "[CLS]", "[SEP]"]
# Replace with: LABEL_LIST = [LABEL_1, LABEL_2, ..., LABEL_N, "X", "[CLS]", "[SEP]"]

LABEL_LIST = ['B-CRIME', 'I-CRIME', 'B-TRANSPORT_HAZARDS','I-TRANSPORT_HAZARDS', 'B-SUICIDE_ATTACK', 'I-SUICIDE_ATTACK', 'B-VEHICULAR_COLLISION', 'I-VEHICULAR_COLLISION', 'B-INDUSTRIAL_ACCIDENT', 'I-INDUSTRIAL_ACCIDENT', 'B-FIRE', 'I-FIRE', 'B-AVIATION_HAZARD', 'I-AVIATION_HAZARD', 'B-SHOOT_OUT', 'I-SHOOT_OUT', 'B-RIOTS', 'I-RIOTS' , 'B-ACCIDENTS', 'I-ACCIDENTS', 'B-TRAIN_COLLISION', 'I-TRAIN_COLLISION', 'B-SURGICAL_STRIKES', 'I-SURGICAL_STRIKES', 'B-MISCELLANEOUS', 'I-MISCELLANEOUS', 'B-NORMAL_BOMBING', 'I-NORMAL_BOMBING', 'B-ARMED_CONFLICTS', 'I-ARMED_CONFLICTS', 'B-TERRORIST_ATTACK', 'I-TERRORIST_ATTACK','B-FOREST_FIRE', 'I-FOREST_FIRE', 'B-EARTHQUAKE', 'I-EARTHQUAKE', 'B-FLOODS', 'I-FLOODS', 'B-STORM', 'I-STORM', 'B-COLD_WAVE', 'I-COLD_WAVE', 'B-TORNADO', 'I-TORNADO', 'B-CYCLONE', 'I-CYCLONE', 'B-DROUGHT', 'I-DROUGHT', 'B-FAMINE', 'I-FAMINE', 'B-VOLCANO', 'I-VOLCANO', 'B-AVALANCHES', 'I-AVALANCHES', 'B-LIMNIC_ERRUPTIONS', 'I-LIMNIC_ERRUPTIONS', 'B-LAND_SLIDE', 'I-LAND_SLIDE', 'B-HAIL_STORMS', 'I-HAIL_STORMS', 'B-HURRICANE', 'I-HURRICANE', 'B-TSUNAMI', 'I-TSUNAMI', 'B-BLIZZARD', 'I-BLIZZARD', 'B-HEAT_WAVE', 'I-HEAT_WAVE', 'B-ROCK_FALL', 'I-ROCK_FALL', 'B-HEAVY_RAINFALL', 'I-HEAVY_RAINFALL', 'B-EPIDEMIC', 'I-EPIDEMIC',"O" ,"X", "[CLS]", "[SEP]"]
...
class Corpus(object):
    def __init__(self, bert_model, max_seq_length, logger, language, mode, load_data=False, support_size=-1,
        ...
        if k_shot_prop > 0:
            ...
            print("k-shotttttttttttttttttttttttt")
    ...
    def build_original_features(self, lang, mode, load_data=True):
        ...
        if not load_data:
            tokens_labels = self._prepare_data(examples, 'data/{}-{}-processed.txt'.format(lang, mode),mode)
        else:
    ...
    def _prepare_data(self, examples, fn, mode):
        ...
        for (ex_index, example) in enumerate(examples):
            ...
            #if (mode =='test' and (ex_index == 45 or ex_index==117)) :
                #continue
