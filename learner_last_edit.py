...
#from transformers import  AutoForTokenClassification
...
class Learner(nn.Module):
    def __init__(self, bert_model, label_list, freeze_layer, logger, lr_meta, lr_inner,
        ...
        if model_dir != '':
            ...
            self.model = AutoModelForTokenClassification.from_pretrained(bert_model, cache_dir=cache_dir, num_labels=num_labels)
